...
function Footer() {
    return (
        <div className="bg-third_background">
            <div className="flex justify-center items-center">
                <div className="space-y-4 text-sm max-w-screen-lg mt-6 text-secondary_text opacity-60 border-b-2 border-seconary_text mb-5 pl-5 pr-5">
                    ...
                    <p>2. Compared to AirPods Pro (1st generation).</p>
                    ...
                    <p className="pb-8">Major League Baseball trademarks and copyrights are used with permission of MLB Advanced Media, L.P. All rights reserved.</p>
                </div>
            </div>

            <div className="flex justify-center items-center">
                <div className="space-y-4 text-sm max-w-screen-lg mt-1 text-secondary_text opacity-60 mb-5 pl-5 pr-5  ">
